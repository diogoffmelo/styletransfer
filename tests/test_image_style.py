...
content_loss_op = tf.constant(0, dtype=tf.float32)
#content_loss_op = build_losses(content_feats_op, content_feats_target, 1e-3)
style_loss_op = build_losses(style_feats_op, style_feats_target, 1e-4)
denoising_loss_op = _tv_loss(inputs)
...
#loss = content_loss_op + style_loss_op + 1e-5 * denoising_loss_op
